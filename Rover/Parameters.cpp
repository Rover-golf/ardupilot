...
//GOLF
    ...
    GSCALAR(batt_charge_to, "GF_BAT_CHARGE", 58),
    GSCALAR(unload_sec, "GF_UNLOAD_SEC", 30),
    GSCALAR(test_full_sec, "GF_RTL_SEC", 360),
    GSCALAR(home_offset, "GF_HOME_OFFSET", 100),
    GSCALAR(pwm_normal, "GF_PWM_NORMAL", 2000),
    GSCALAR(steer_rate_use, "GF_STEER_RATE", 4500),
    GSCALAR(steer_yaw_min, "GF_STEER_MIN", 800),
    GSCALAR(steer_error, "GF_STEER_ERR", 8),

    GSCALAR(golf_yawrate_k, "GF_GD_YAWRATE", 10),
    GSCALAR(golf_forward, "GF_GD_AHEAD", 30),
    GSCALAR(golf_max_degerr, "GF_GD_DEGERR", 8),
    GSCALAR(golf_max_turn, "GF_GD_MAXTURN", 4500),

    GSCALAR(golf_yaw, "GF_YAW", 180),
    GSCALAR(golf_throttle, "GF_THROTTLE", 30),
    ...
    GSCALAR(uwb_enable, "GF_UWB_ENABLE", 0), 
    GSCALAR(uwb_angleL, "GF_UWB_ANGLEL", 15),
    GSCALAR(uwb_angleR, "GF_UWB_ANGLER", -15),
